...
export default class Shop extends React.Component {
    ...
    renderNavigationView(){
        return(
            <View style={styles.navViewStyle}>
                <Image source={{url: "icon_shop_local",scale: 2}} style={styles.iconImgStyle}/>
                <Text style={styles.navTitleStyle}>商家</Text>
                <Image source={{url: "icon_shop_search",scale: 2}} style={styles.iconImgStyle}/>
            </View>
        )
    }
    ...
    componentDidMount(){
        // this.fetchMeiTuanShopList()
    }

    fetchMeiTuanShopList(){
